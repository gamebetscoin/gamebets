...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Gamebets Core"),
     ...
     * override -datadir in the gamebets.conf file in the default data directory
     * (to be consistent with gamebetsd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
