                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Gamebets Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GBC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gamebets: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Gamebets Core"), this);
    aboutAction->setStatusTip(tr("Show information about Gamebets Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Gamebets"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GBC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GBC addresses"));
    ...
    openAction->setStatusTip(tr("Open a gamebets: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gamebets Core help message to get a list with possible Gamebets command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Gamebets Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to the Gamebets network", "", count));
}
...
{
    QString strTitle = tr("Gamebets Core"); // default title
