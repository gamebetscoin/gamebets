...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='gamebets.conf'
CONFIGFOLDER='/root/.gamebets'
COIN_DAEMON='gamebetsd'
COIN_CLI='gamebets-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/GamebetsCoin/Gamebets/releases/download/v1.0.0/gamebets-1.0.0-x86_64-linux-gnu.tar.gz'
