...
This mechanism has been integrated into Bitcore-Node-Gamebets which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gamebets/insight-api-gamebets#web-socket-api](https://github.com/gamebets/insight-api-gamebets#web-socket-api)
* API: [https://github.com/gamebets/insight-api-gamebets#swifttx-transactions](https://github.com/gamebets/insight-api-gamebets#swifttx-transactions)
...
By default, the Gamebets Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Gamebets Core daemon:
