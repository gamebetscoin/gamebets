...
RESOURCES += src/qt/gamebets.qrc src/qt/gamebets_locale.qrc

TRANSLATIONS += src/qt/locale/gamebets_bg.ts \
                src/qt/locale/gamebets_de.ts \
                src/qt/locale/gamebets_en.ts \
                src/qt/locale/gamebets_es.ts \
                src/qt/locale/gamebets_fi.ts \
                src/qt/locale/gamebets_fr.ts \
                src/qt/locale/gamebets_it.ts \
                src/qt/locale/gamebets_ja.ts \
                src/qt/locale/gamebets_pl.ts \
                src/qt/locale/gamebets_pt.ts \
                src/qt/locale/gamebets_ru.ts \
                src/qt/locale/gamebets_sk.ts \
                src/qt/locale/gamebets_sv.ts \
                src/qt/locale/gamebets_vi.ts \
                src/qt/locale/gamebets_zh_CN.ts \
                src/qt/locale/gamebets_zh_TW.ts
