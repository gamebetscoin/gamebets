...
#if defined(NDEBUG)
#error "Gamebets cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uGBC) are considered zero fee (for relaying and mining)
...
{
    RenameThread("gamebets-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // GBC: We use certain sporks during IBD, so check to see if they are
