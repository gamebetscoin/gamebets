...
#   c) node1 mines 32 blocks, so now node 0 has 500000GBC, node 1 has 4250GBC, node2 has none.
#   d) node0 sends 601 GBC to node2, in two transactions (301 GBC, then 300 GBC).
