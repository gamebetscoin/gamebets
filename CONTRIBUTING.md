Contributing to Gamebets Core
==================================

The Gamebets Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Gamebets Core project, and is not to be
confused with overall Gamebets Network Protocol consensus changes.

Whether a pull request is merged into Gamebets Core rests with the project merge
...
Patches that change Gamebets consensus rules are considerably more involved than
...
Where a patch set proposes to change the Gamebets consensus, it must have been
...
The project lead is the release manager for each Gamebets Core release.
