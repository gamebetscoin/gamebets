...
/** Utility functions used by the Gamebets Qt UI.
 */
namespace GUIUtil
{
...
// Render GBC addresses in monospace font
...
// Parse "gamebets:" URI into recipient object, return true on successful parsing
