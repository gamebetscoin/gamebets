...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Gamebets server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Gamebets server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Gamebets features */
        {"gamebets", "masternode", &masternode, true, true, false},
        {"gamebets", "listmasternodes", &listmasternodes, true, true, false},
        {"gamebets", "getmasternodecount", &getmasternodecount, true, true, false},
        {"gamebets", "masternodeconnect", &masternodeconnect, true, true, false},
        {"gamebets", "masternodecurrent", &masternodecurrent, true, true, false},
        {"gamebets", "masternodedebug", &masternodedebug, true, true, false},
        {"gamebets", "startmasternode", &startmasternode, true, true, false},
        {"gamebets", "createmasternodekey", &createmasternodekey, true, true, false},
        {"gamebets", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"gamebets", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"gamebets", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"gamebets", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"gamebets", "getmasternodescores", &getmasternodescores, true, true, false},
        {"gamebets", "mnbudget", &mnbudget, true, true, false},
        {"gamebets", "preparebudget", &preparebudget, true, true, false},
        {"gamebets", "submitbudget", &submitbudget, true, true, false},
        {"gamebets", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"gamebets", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"gamebets", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"gamebets", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"gamebets", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"gamebets", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"gamebets", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gamebets", "checkbudgets", &checkbudgets, true, true, false},
        {"gamebets", "mnsync", &mnsync, true, true, false},
        {"gamebets", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> gamebets-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6000/\n";
}
