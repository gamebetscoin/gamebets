...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case GBC:
            return QString("tGBC");
        case mGBC:
            return QString("mtGBC");
        case uGBC:
            return QString::fromUtf8("μtGBC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case GBC:
            return QString("GBC");
        case mGBC:
            return QString("Milli-GBC (1 / 1" THIN_SP_UTF8 "000)");
        case uGBC:
            return QString("Micro-GBC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case GBC:
            return QString("TestGBCs");
        case mGBC:
            return QString("Milli-TestGBC (1 / 1" THIN_SP_UTF8 "000)");
        case uGBC:
            return QString("Micro-TestGBC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
