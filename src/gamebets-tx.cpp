...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Gamebets Core gamebets-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  gamebets-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gamebets transaction") + "\n" +
                               "  gamebets-tx [options] -create [commands]   " + _("Create hex-encoded gamebets transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gamebets transaction
